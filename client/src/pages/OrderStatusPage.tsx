...
const OrderStatusPage = () => {
  ...
  const handleOrderMore = () => {
    if (order && order.tableNumber && order._id) {
      // Try to extract restaurantId from orderId (if possible) or store it in localStorage/sessionStorage when ordering
      // For now, try to get restaurantId from localStorage (set it in OrderPage when placing order)
